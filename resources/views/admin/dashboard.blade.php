                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="mt-2 mb-0 text-muted text-xs">
                                                <span>Pada Bulan {{ $current_month }}</span>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">SIAP JUAL</div>
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                {{ $kambing->count() }}</div>
                                            <div class="mt-2 mb-0 text-muted text-xs">
                                                <span>Jumlah Kambing Siap Jual</span>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">Proses
                                                Penggemukkan
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                {{ $penggemukan->count() }}</div>
                                            <div class="mt-2 mb-0 text-muted text-xs">
                                                <span>Jumlah Kambing Penggemukan</span>
                                            </div>
                                        </div>
                                        <div class="col-auto">
