        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <form action="{{ route('update-kambing-akhir', $penerimaan->id_penerimaan) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            @if ($penerimaan)
                                @for ($i = 0; $i < $penerimaan->total_penerimaan; $i++)
                                    @php
                                        ...
                                        $existingKambingAkhir = $kambingakhir[$i] ?? null;
                                    @endphp
                                    <div class="col-lg-6">
                                        <div class="card mb-4">
                                            <div
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="kode_kambing[]"
                                                        value="{{ $existingKambing->kode_kambing ?? '' }}" readonly>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        value="{{ $existingKambing->umur ?? '' }}"readonly>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control harga_beli"
                                                        ...
                                                        value="{{ $existingKambing->harga_beli ?? '' }}"readonly>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="berat_badan_akhir_{{ $i }}">Berat Hewan
                                                        Akhir
                                                        (Kg)</label>
                                                    <input type="number" class="form-control"
                                                        id="berat_badan_akhir_{{ $i }}"
                                                        placeholder="Berat Hewan (Kg)" min="0"
                                                        name="berat_badan_akhir[]" required
                                                        value="{{ $existingKambingAkhir->berat_badan_akhir ?? '' }}">
                                                </div>

                                                <div class="form-group">
                                                    <label for="tinggi_badan_akhir_{{ $i }}">Tinggi Hewan
                                                        Akhir (Cm)</label>
                                                    <input type="number" class="form-control"
                                                        id="tinggi_badan_akhir_{{ $i }}"
                                                        placeholder="Tinggi Hewan Akhir (Cm)" required min="0"
                                                        name="tinggi_badan_akhir[]"
                                                        value="{{ $existingKambingAkhir->tinggi_badan_akhir ?? '' }}">
                                                </div>

                                                <div class="form-group">
                                                    <label for="poel_akhir_{{ $i }}">Poel Akhir</label>
                                                    <input type="number" class="form-control"
                                                        id="poel_akhir_{{ $i }}" placeholder="Poel Akhir"
                                                        required min="0" name="poel_akhir[]"
                                                        value="{{ $existingKambingAkhir->poel_akhir ?? '' }}">
                                                </div>
